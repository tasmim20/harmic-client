    ...
    <div className="form-control">
     ...
     <option>Seller</option>
      ...
      <label className="label text-purple-700">
        ...
        <Link to='/login' className=" text-red font-semibold">Login</Link>
      </label>
    </div>
    <div className='flex justify-start'>
    <input type="radio" name="radio-7" className="radio radio-info text-lime" /> 
    <p>Accept terms and condition.?</p>
    </div>
    <p className='text-error'>{passwordError}</p>
      {success && <p className='text-black'>User Created Successfully.</p>}
    <div className="form-control mt-6">
       <input type="submit"  className="btn btn-outline-danger  btn-success bg-lime hover:bg-black hover:text-white" value="signUp"/>
