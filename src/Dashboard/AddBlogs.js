...
const AddBlogs = () => {
    ...
    return (
        <div>
           <div className="hero  bg-base-200 max-h-full mb-20" style={{backgroundImage:`url(${bg})`, minHeight:610}}>
  <div className="hero-content flex-col lg:flex-row-reverse">
    <img src={tometo} className=" rounded-lg " />
    <div className="card flex-shrink-0 w-full max-w-sm shadow-2xl bg-base-100">
      <form  onSubmit={handleSubmit(onSubmit)} className="card-body">
        ...
        <div className="form-control">
          ...
          <input {...register("image", { required: true})} type="text" placeholder="Image" className="input input-bordered" />
        ...
        <div className="form-control mt-6">
          <button type='submit' className="btn btn-white bg-lime hover:bg-black hover:text-white">Add Blog</button>
        </div>
      </form>
    </div>
  </div>
